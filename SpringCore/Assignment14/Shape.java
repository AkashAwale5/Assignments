package ass14;
//WAP in which you have to create objects on user demands. For example we are having a 
//Interface Shape, now class circle, rectangle and square implements shape interface and 
